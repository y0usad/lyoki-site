        ...
        <div className="flex min-h-screen bg-[#0a0a0a] text-gray-300 font-sans">
            ...
            <aside className="w-64 border-r border-gray-800 flex flex-col p-4">
                ...
                <div className="space-y-6 flex-1">
                    <div>
                        <p className="text-xs text-gray-600 uppercase font-bold px-2 mb-2">Application</p>
                    ...
                    <div>
                        <p className="text-xs text-gray-600 uppercase font-bold px-2 mb-2">Products</p>
                        <nav className="space-y-1">
                    ...
                    <div>
                        <p className="text-xs text-gray-600 uppercase font-bold px-2 mb-2">Users</p>
                        <nav className="space-y-1">
                    ...
                    <div>
                        <p className="text-xs text-gray-600 uppercase font-bold px-2 mb-2">Orders / Payments</p>
                        <nav className="space-y-1">
                            <button onClick={() => navigate('/admin/transactions')} className={`flex items-center gap-3 w-full p-2 hover:bg-gray-900 rounded ${isActive('/admin/transactions')}`}>
                                <CreditCard size={18} /> All Transactions
                            </button>
                        </nav>
                    </div>
                </div>
